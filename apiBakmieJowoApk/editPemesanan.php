...
$query = mysqli_query($koneksi,"update pemesanan set id_user='$id_user',nama_user='$nama_user',id_makanan='$id_makanan',nama_makanan='$nama_makanan',harga_makanan='$harga_makanan',id_minuman='$id_minuman',nama_minuman='$nama_minuman',harga_minuman='$harga_minuman',id_tambahan='$id_tambahan',nama_tambahan='$nama_tambahan',harga_tambahan='$harga_tambahan',keterangan='$keterangan',total='$total' where id='$id'");
}
